...
This is my first post to my blog.  This post is part of a project I am working on at my job at Virginia Tech.  Part of the project involved creating a map of buildings on campus and mapping amounts to show spending over a period of time.  Due to the confidentiality of the spending amounts, I decided to webscrape campus buildings and their ages from this [website](https://vt.edu/about/locations/buildings.html) and map them using the leaflet package in R.
...
#### Scrape Website
To start, I used the rvest package to web scrape the vt.edu/location/buidlings website for the names of all the buildings.  
```{r}
...
```{r, fig.align="center", fig.width=6, fig.height=6, fig.cap="Map of Virginia Tech Buildings Colored by Age."}
vt_df %>%
  leaflet() %>%
